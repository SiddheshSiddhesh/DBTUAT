...
{
    public partial class PreSanctionletterMarathi : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Literal1.Text = cla.SvrDate();
                Literal4.Text = dt.Rows[0]["ApplicationDate"].ToString();
                Literal5.Text = dt.Rows[0]["MeetingDate"].ToString();
                Literal6.Text = dt.Rows[0]["ApplicationCode"].ToString();
                Literal10.Text = dt.Rows[0]["Hectare8A"].ToString();
                Literal11.Text = dt.Rows[0]["SurveyNo712"].ToString();
                Literal12.Text = dt.Rows[0]["Are712"].ToString();
                Literal17.Text = dt.Rows[0]["ActivityName"].ToString();
                Literal22.Text = cla.SvrDate();
                Literal23.Text = dt.Rows[0]["ApplicationCode"].ToString();
                String adds = "";
                ...
                Literal20.Text = dt.Rows[0]["Subdivisions"].ToString();
                Literal9.Text = dt.Rows[0]["Taluka"].ToString();
                Literal8.Text = dt.Rows[0]["VillageName"].ToString();
                Literal15.Text = dt.Rows[0]["Cityname"].ToString();
                Literal21.Text = dt.Rows[0]["Cityname"].ToString();
