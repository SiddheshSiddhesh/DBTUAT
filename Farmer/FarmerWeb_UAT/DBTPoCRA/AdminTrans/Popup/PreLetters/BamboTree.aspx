<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BamboTree.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.BamboTree" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px; padding-top:0px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left;">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- बांबू लागवड  </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक- A2.2.1) </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
                  ...
                  <tr><td colspan="3">
                      <table border="1" class="table-responsive" style=" border: 1px solid black; border-collapse: collapse; width:100%;">
                       <tr>
                        <td style="width:20px;">१ </td>
                    ...
                    <tr>
                        ...
                        <td><asp:Literal ID="Literal15" runat="server"></asp:Literal></td>
                          ...
                          <tr>
                              <td> १० </td>
                              <td>वृक्ष लागवडीसाठी मागणी केलेले क्षेत्र (हे. आर.)  </td>
                    ...
                    <tr>
                       <td colspan="3" style="text-align: justify"><br />
                         &nbsp;&nbsp;&nbsp; 
                           ...
                           वरील अर्जाच्या अनुषंगाने आपणास कळविण्यात येते कि, ग्राम कृषि संजीवनी समितीने (VCRMC) वरील ठरावान्वये आपली लाभार्थी म्हणून निवड केलेली आहे. सदर निवड आपण प्रकल्पाच्या अटी व शर्तीच्या पूर्तता करण्याचे अधिन राहून करण्यात आली आहे.  आपल्या मागणीनुसार बांबू  लागवड  या बाबीसाठी प्रकल्पांतर्गत मार्गदर्शक सूचनेनुसार अनुज्ञेय रकमेसाठी पूर्वसंमती देण्यात येत आहे. पूर्वसंमतीपत्र दिल्याच्या तारखेपासून दिलेल्या मुदतीत बांबू लागवड करणे आवश्यक आहे. सदर प्रकल्प उभारणीसाठी लाभार्थ्याने सर्व खर्च अगोदर स्वत: करावयाचा आहे. घटकाची अंमलबजावणी पूर्ण करून आवश्यक कागदपत्र https://dbt.mahapocra.gov.in या संकेतस्थळावर किंवा DBT app वर अपलोड करून अनुदान मागणी करणे आवश्यक आहे. विहित मुदतीत घटकाची अंमलबजावणी पूर्ण न झाल्यास आपणास दिलेले पूर्वसंमती पत्र आपोआप रद्द समजण्यात यावे.
