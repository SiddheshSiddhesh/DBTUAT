<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolytunnelPlantMatFlower.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.PolytunnelPlantMatFlower" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- पॉली टनेलमध्ये फुलपिके लागवड साहित्य  </td>
                     </tr>  
                   ...
                   <tr>
                    ...
                    <tr>
                        <td>९</td>
                        <td>स्थळ पाहणी करून कृषि सहाय्यकाने शिफारस केल्याचा दिनांक करीता मागणी केलेले आकारमान (चौ. मी.) </td>
                        <td><asp:Literal ID="Literal15" runat="server"></asp:Literal></td>
                    </tr>
                   <tr>
                       <td>१०</td>
                       <td>पॉली टनेलमध्ये फुलपिके लागवड करिता पूर्वसंमती   </td>
