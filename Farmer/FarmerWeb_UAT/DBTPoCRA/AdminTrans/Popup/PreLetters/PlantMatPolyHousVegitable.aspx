<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantMatPolyHousVegitable.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.PlantMatPolyHousVegitable" %>
          ...
          <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- पॉली हाऊस मध्ये भाजीपाला लागवड साहित्य   </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक-A2.4.5)  </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:Literal ID="Literal19" runat="server"></asp:Literal>.<asp:Literal ID="Literal1" runat="server">  </asp:Literal>                 
                        </td>
                    </tr>
                    <tr>
                        <td>९</td>
                        <td>स्थळ पाहणी करून कृषि सहाय्यकाने शिफारस केल्याचा दिनांक करीता मागणी केलेले आकारमान (हे. आर.) </td>
                        <td><asp:Literal ID="Literal15" runat="server"></asp:Literal></td>
                    </tr>
                    <tr>
                        <td>१०</td>
                        <td>पॉली हाऊस मध्ये भाजीपाला लागवड करिता पूर्वसंमती देण्यात आलेले क्षेत्र (हे. आर.)  </td>
                        <td><asp:Literal ID="Literal24" runat="server"></asp:Literal>.<asp:Literal ID="Literal20" runat="server"></asp:Literal></td>
                    </tr>
                          <tr>
                        <td>११</td>
                        ...
                        <td><asp:Literal ID="Literal16" runat="server"></asp:Literal></td>
                          ...
                          <tr>
                        <td>१२</td>
                         <td> पूर्व  संमती देण्यात आलेले  आकारमान (हे. आर.) </td>
                    ...
                    <tr>
                       <td colspan="3" style="text-align: justify"><br />
                         &nbsp;&nbsp;&nbsp;  वरील अर्जाच्या अनुषंगाने आपणास कळविण्यात येते कि, ग्राम कृषि संजीवनी समितीने (VCRMC) वरील ठरावान्वये आपली लाभार्थी म्हणून निवड केलेली आहे. सदर निवड आपण प्रकल्पाच्या अटी व शर्तीच्या पूर्तता करण्याचे अधिन राहून करण्यात आली आहे. आपल्या मागणीनुसार पॉली हाऊस मध्ये भाजीपाला लागवड या बाबीसाठी प्रकल्पांतर्गत मार्गदर्शक सूचनेनुसार अनुज्ञेय रकमेसाठी पूर्वसंमती देण्यात येत आहे. सदरचे पूर्वसंमतीपत्र दिल्याच्या तारखेपासून दिलेल्या मुदतीत आपण पॉली हाऊस मध्ये भाजीपाला लागवड पूर्ण करावी. दिलेल्या मुदतीत प्रकल्पाचे काम पूर्ण न केल्यास आपणास दिलेले पूर्वसंमती पत्र आपोआप रद्द समजण्यात यावे. दिलेल्या मुदतीत भाजीपाला लागवड पुर्ण करून आवश्यक कागदपत्र https://dbt.mahapocra.gov.in या संकेतस्थळावर किंवा DBT app वर अपलोड करून अनुदान मागणी करणे आवश्यक आहे.काम पूर्ण न करता फक्त कामाची देयके अपलोड केल्यास निधी अदायगी मध्ये विलंब होण्याची शक्यता नाकारता येत नाही. तसेच विहित मुदतीत संच न बसवल्यास पूर्वसंमती पत्र आपोआप रद्द समजण्यात यावे. </tr>

                    <tr>
                       
                        <td colspan="3" style="text-align: justify"><br />
                          &nbsp;&nbsp;&nbsp;   भाजीपाला लागवड मार्गदर्शक सूचनेतील निकषानुसार असेल तरच आपला प्रस्ताव प्रत्यक्ष मोका तपासणीनुसार देय अनुदानासाठी पात्र राहिल. आपला प्रस्ताव मंजूर झाल्यानंतर मार्गदर्शक सुचना व मंजूर मापदंड/प्रत्यक्ष खर्चानुसार अनुज्ञेय अनुदान निधी उपलब्धतेनूसार मंजूर करण्यात येईल. सदरचे अनुदान आपल्या आधार संलग्न बँक खात्यावर DBT द्वारे जमा करण्यात येईल. आपल्या प्रस्तावास मंजूरी देणे, देय अनुदानाची रक्कम/देय कालावधी इत्यादी बाबी ठरविण्याचा अंतिम अधिकार नानाजी देशमुख कृषि संजीवनी प्रकल्प/शासनाचा राहिल.</td>    
                          </tr> 
                 <tr>
                     <td colspan="3" style="text-align: justify"><br />
