...
{
    public partial class Agroforesty : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Literal1.Text = dt.Rows[0]["ApplicationCode"].ToString();//ApplicationID
                ...
                Literal11.Text = dt.Rows[0]["PostName"].ToString();//Subdivisions
