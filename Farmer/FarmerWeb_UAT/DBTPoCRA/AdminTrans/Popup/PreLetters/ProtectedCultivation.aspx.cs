...
{
    public partial class ProtectedCultivation : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Literal14.Text = dt.Rows[0]["ApplicationCode"].ToString();
                Literal15.Text = dt.Rows[0]["Are8A"].ToString();
                Literal16.Text = dt.Rows[0]["SurveyNo712"].ToString();
