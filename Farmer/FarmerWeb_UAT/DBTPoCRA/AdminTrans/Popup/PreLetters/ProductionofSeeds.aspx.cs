...
{
    public partial class ProductionofSeeds : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Literal23.Text = dt.Rows[0]["Are712"].ToString();
                ...
                Literal24.Text = dt.Rows[0]["PostName"].ToString();
                Literal25.Text = dt.Rows[0]["AreaOfLandUsed"].ToString();
