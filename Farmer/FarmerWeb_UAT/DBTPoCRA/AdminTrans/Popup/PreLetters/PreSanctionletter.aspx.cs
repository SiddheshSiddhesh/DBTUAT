...
namespace DBTPoCRA.AdminTrans.Popup
{
    public partial class PreSanctionletter : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Literal5.Text = dt.Rows[0]["PresenctionDate"].ToString();
                Literal6.Text = dt.Rows[0]["OutwardNo"].ToString();
                Literal22.Text = dt.Rows[0]["ActivityCode"].ToString();
                Literal7.Text = dt.Rows[0]["Subdivisions"].ToString();
                Literal23.Text = dt.Rows[0]["Cityname"].ToString();
                Literal1.Text = dt.Rows[0]["Subdivisions"].ToString();
                Literal2.Text = dt.Rows[0]["Cityname"].ToString();

                Literal10.Text = dt.Rows[0]["ApplicationDate"].ToString();
                Literal11.Text = dt.Rows[0]["PresenctionDate"].ToString();
                Literal12.Text = dt.Rows[0]["ActivityName"].ToString();
                Literal13.Text = dt.Rows[0]["Are712"].ToString();
                Literal14.Text = dt.Rows[0]["TimeLineDay"].ToString();
                ...
                adds = "श्री/श्रीमती : " + dt.Rows[0]["RegisterName"].ToString();
                //adds += "<br> Street Name : " + dt.Rows[0]["Address1StreetName"].ToString();
                adds += "<br> गाव : " + dt.Rows[0]["VillageName"].ToString();
                adds += "<br> पोस्ट : " + dt.Rows[0]["PostName"].ToString();
                adds += "    तालूका  : " + dt.Rows[0]["Subdivisions"].ToString();
                adds += "<br> जिल्हा  : " + dt.Rows[0]["Cityname"].ToString() + "    पिन कोड - " + dt.Rows[0]["Address1PinCode"].ToString();
            ...
            //    String RegistrationID = dt.Rows[0]["RegistrationID"].ToString();
            //    Literal1.Text = dt.Rows[0]["ApplicationCode"].ToString();
            //    Literal2.Text = cla.SvrDate(); 
            //    Literal3.Text = dt.Rows[0]["RegisterName"].ToString();


            //    Literal5.Text = dt.Rows[0]["ApplicationDate"].ToString();
            //    Literal6.Text = dt.Rows[0]["ActivityName"].ToString();
