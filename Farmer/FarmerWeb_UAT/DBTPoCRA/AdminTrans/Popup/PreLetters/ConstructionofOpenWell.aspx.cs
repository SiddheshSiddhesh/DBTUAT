...
{
    public partial class ConstructionofOpenWell : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                // Literal19.Text = dt.Rows[0]["Are712"].ToString();
                // Literal20.Text = dt.Rows[0]["ApplicationCode"].ToString();
