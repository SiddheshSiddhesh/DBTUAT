<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pumps.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.Pumps" %>
                 ...
                 <table class="auto-style1" style=" text-align: left; font-family: Calibri; font-size: 15px;">
                    ...
                    <tr>
                        <td colspan="3" style="font-weight: 700"><%--<h4 style="text-align: center">प्रपत्र -३</h4>--%><br />
                            ...
                            <h4 style="text-align: center">अ ३ (८) (i) व अ ३ (८) (ii) </h4>        
                         ...
                         <td colspan="3">&nbsp;&nbsp;</td>
                          ...
                          <tr>
                            <td colspan="3">प्रति,</td>                        
                             ...
                             <tr>
                                 <td colspan="3" style="text-align:justify;">आपल्या दिनांक  <asp:Literal ID="Literal4" runat="server"></asp:Literal>रोजीच्या अर्जाप्रमाणे पाणी साठवण संरचनाची निर्मिती  घटकांतर्गत पाणी उपसा साधने (पंप संच / पाईप (एच.डी.पी.ई. / पी.व्ही.सी.) उपघटकासाठी आपली लाभार्थी म्हणून निवड करण्यात आली आहे. अटी व शर्तीची पूर्तता करण्याच्या अधिन राहून आपणांस (विद्युत पंप संच/डिझेल इंजिन)/पाईप (एच.डी.पी.ई./पी.व्ही.सी.) बाबींच्या कामास प्रकल्पांतर्गत मार्गदर्शक सूचनेनुसार अनुज्ञेय रकमेसाठी पूर्वसंमती देण्यात येत आहे. आपल्या पसंतीनुसार (विद्युत पंप /डिझेल इंजिन) /पाईप खरेदी करण्यास आपणास मुभा आहे. सदरचे पूर्वसंमती पत्र मिळाल्यापासून ३० दिवसांच्या आत आपण घटकाची अंमलबजावणी पूर्ण करणे बंधनकारक राहील अन्यथा सदर पूर्व संमती रद्द होईल याची नोंद घ्यावी. 
                                 </td>
                             </tr>
                             <tr>
                                 <td colspan="3" style="text-align:justify;">सदर घटकाची अंमलबजावणी मार्गदर्शक सूचनेनुसार पूर्ण झाल्याची खात्री झाल्यानंतर आपणास शासन निर्णयानुसार (मार्गदर्शक सुचना व मंजूर मापदंड इत्यादी) अनुज्ञेय अनुदान निधी उपलब्धते नूसार मंजूर करण्यात येईल. तसेच सदरचे अनुदान आपल्या राष्ट्रीयकृत बँकखात्यावर जमा करण्यात येईल. आपल्या प्रकल्प प्रस्तावास मंजूरी देणे, देय अनुदानाची रक्कम/देय कालावधी इत्यादी बाबी ठरविण्याचा अंतिम अधिकार नानाजी देशमुख कृषि संजीवनी प्रकल्प/शासनाचा राहील.</td>
                             </tr>                             
                             <tr>
                                 <td>&nbsp;</td>
                                 <td>&nbsp;</td>
                             ...
                             <tr>
                                 <td colspan="3">1)	जिल्हा अधिक्षक कृषी अधिकारी <asp:Literal ID="Literal1" runat="server"></asp:Literal></td>
                             </tr>
                             <tr>
