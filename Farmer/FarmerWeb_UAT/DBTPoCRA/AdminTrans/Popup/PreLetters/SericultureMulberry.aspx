<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SericultureMulberry.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.SericultureMulberry" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- रेशीम उद्योग   </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक-A2.5.3)  </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
                  ...
                  <td colspan="3">
                    ...
                    <tr>
                        ...
                        <td><asp:Literal ID="Literal15" runat="server"></asp:Literal></td>
                          ...
                          <tr>
                              <td>१०</td>
                              <td>तुती रोपे तयार करण्यासाठी मागणी केलेले क्षेत्र (हे. आर.)</td>
