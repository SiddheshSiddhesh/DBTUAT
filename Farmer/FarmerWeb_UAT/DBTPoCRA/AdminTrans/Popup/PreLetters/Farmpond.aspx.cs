...
{
    public partial class Farmpond : System.Web.UI.Page
    {
        ...
        private void FillDetails(String ApplicationID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Literal1.Text = dt.Rows[0]["MaxSubsidyAmt"].ToString();

                Literal7.Text = dt.Rows[0]["ApplicationCode"].ToString();
                //  Literal7.Text = cla.SvrDate();// dt.Rows[0]["ApplicationDate"].ToString();Literal18
                Literal17.Text = dt.Rows[0]["ApplicationDate"].ToString();
                Literal18.Text = dt.Rows[0]["MeetingDate"].ToString();
                Literal12.Text = dt.Rows[0]["RegisterName"].ToString();
                Literal24.Text = dt.Rows[0]["SurveyNo712"].ToString();
                // Literal13.Text = cla.SvrDate();// dt.Rows[0]["ApplicationDate"].ToString();
                Literal23.Text = dt.Rows[0]["RegisterName"].ToString();
               // Literal22.Text = dt.Rows[0]["ActivityName"].ToString();
