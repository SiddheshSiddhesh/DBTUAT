    ...
    public class AntiDosAttack
    {
        ...
        public static void Monitor(int Capacity, int Seconds2Keep, int AllowedCount)
        {
            ...
            if (count > AllowedCount)
            {
                ...
                Util.LogError("Blocked probable ongoing ddos attack"+ HttpContext.Current.Request.UserHostAddress);
                HttpContext.Current.Response.Redirect("~/ErrorLog.aspx?message=429");
