...
{
    /// <summary>
    /// Summary description for CaptchaT
    /// </summary>
    public class CaptchaT : IHttpHandler, IReadOnlySessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int[] aFontEmSizes = new int[] { 15, 20, 25};
 ...
 HatchStyle.WideDownwardDiagonal, HatchStyle.WideUpwardDiagonal, HatchStyle.ZigZag
            ...
            Random oRandom2 = new Random();
            int iNumber = oRandom2.Next(1000, 9999);
            HttpContext.Current.Session["Captcha"] = iNumber.ToString();
            string sCaptchaText = iNumber.ToString();
