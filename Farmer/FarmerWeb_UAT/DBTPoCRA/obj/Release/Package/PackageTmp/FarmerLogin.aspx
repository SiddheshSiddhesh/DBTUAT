<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FarmerLogin.aspx.cs" Inherits="DBTPoCRA.FarmerLogin" %>
...
<head runat="server">
    ...
    <title>PoCRA::Farmer Login</title>
    <!-- CSS -->
...
<body class="light">
                            ...
                            <div class="navbar-custom-menu p-t-10">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown custom-dropdown">
                                        ...
                                        <span>
                                            <a class="badge badge-success text-white" href="https://dbt.mahapocra.gov.in/">Home</a>
                                        </span>
                                                    ...
                                                    <div class="col-lg-12">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:RadioButtonList ID="RadioButtonList1" Font-Size="10px" CssClass="forget-pass" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                                                                        ...
                                                                        <asp:ListItem Value="Biometric">  &nbsp; Biometric (Thumb)  &nbsp;</asp:ListItem>
                                                                    </asp:RadioButtonList>
                                                                    <asp:RadioButtonList ID="RadioButtonList2" Visible="false" Font-Size="10px" CssClass="forget-pass" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                                                                        ...
                                                                        <asp:ListItem Value="Biometric">  &nbsp; बॉयोमेट्रिक (थंब)  &nbsp;</asp:ListItem>
                                                                    </asp:RadioButtonList>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-5">
                                                                ...
                                                                <input type="text" id="txtname" autocomplete="off" onkeyup="check_field(this);" onblur="check_field(this);" runat="server" class="form-control" maxlength="12"
                                                                    placeholder="" required />

                                                            </div>
                                                            <div class="col-lg-3" style="text-align: left">

                                                                <asp:Button ID="btnOtp" class="btn btn-outline-success mt-4" runat="server" Text="Send otp" OnClick="btnOtp_Click" />
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input type="password" id="txtPassword" maxlength="10" autocomplete="off" runat="server" class="form-control"
                                                                    placeholder="" required />
                                                        ...
                                                        <div class="row text-center">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <asp:Button ID="btnLogin" CssClass="btn btn-danger btn-lg btn-block" runat="server" Style="max-width: 200px;" Width="80px" Text="Login" OnClick="btnLogin_Click" Visible="false" />
                                                            </div>
    ...
    <script>
        ...
        //    $("#hfLocation").val(JSON.stringify(data, null, 2));
        //    $.ajax({
        //        type: "POST",
        //        url: "FarmerLogin.aspx/LogIP",
        //        data: "{'IPDetails':'" + $("#hfLocation").val() + "'}",
        //        dataType: "json",
        //        contentType: "application/json;charset=utf-8",
        //        success: function (data) {
        //            console.log(data);
