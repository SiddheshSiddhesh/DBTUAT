<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FarmPondA332BlackSoil.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.FarmPondA332BlackSoil" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp;घटक- शेततळे इनलेट व आउटलेट शिवाय (काळी माती) </td>
                     </tr>  
