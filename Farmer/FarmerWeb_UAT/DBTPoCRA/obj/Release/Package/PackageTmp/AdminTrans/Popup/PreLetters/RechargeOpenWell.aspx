<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeOpenWell.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.RechargeOpenWell" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- भूजल पुनर्भरण (विहिरींचे पुर्नभरण)   </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक- A3.5.1) </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
