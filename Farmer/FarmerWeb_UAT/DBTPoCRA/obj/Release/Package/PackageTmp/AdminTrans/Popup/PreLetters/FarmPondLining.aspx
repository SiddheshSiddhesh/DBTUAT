<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FarmPondLining.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.FarmPondLining" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- शेततळे अस्तरीकरण   </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक-A3.3.3)  </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
                   ...
                   <tr>
                       <td>१०</td>
                       <td>अस्तरीकरणासाठी निवडलेला व मंजूर केलेला शेततळ्याचा प्रकार </td>
                      <td>इनलेट आउटलेट शिवाय</td>
                   </tr>
                          <tr>
                        <td>११</td>
                        ...
                        <td><asp:Literal ID="Literal16" runat="server"></asp:Literal></td>
                          ...
                          <tr>
                        <td>१२</td>
                         <td> पूर्व संमती पेठ्यात आकारमान </td>
