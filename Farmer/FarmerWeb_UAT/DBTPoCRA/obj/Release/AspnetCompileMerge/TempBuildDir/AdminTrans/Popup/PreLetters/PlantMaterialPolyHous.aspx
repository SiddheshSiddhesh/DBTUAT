<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantMaterialPolyHous.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.PlantMaterialPolyHous" %>
          ...
          <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- पॉली हाऊस मध्ये फुलपिक लागवड साहित्य  </td>
                     </tr>  
                  ...
                  <tr>
                    ...
                    <tr>
                        <td>१०</td>
                        <td>पॉली हाऊस मध्ये फुलपिक लागवड करिता पूर्वसंमतीकरिता मागणी  केलेले आकारमान (चौ. मी.) </td>
                        ...
                        <td><asp:Literal ID="Literal16" runat="server"></asp:Literal></td>
                          ...
                          <tr>
                        <td>१२</td>
                        <td> पूर्व संमती देण्यात आलेले आकारमान (चौ. मी.) </td>
