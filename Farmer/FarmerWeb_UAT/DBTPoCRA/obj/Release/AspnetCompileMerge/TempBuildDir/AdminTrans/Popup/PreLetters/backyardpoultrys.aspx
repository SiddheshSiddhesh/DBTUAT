<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backyardpoultrys.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.backyardpoultrys" %>
            ...
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                  ...
                  <tr>
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- परसातील कुक्कुटपालन    </td>
                     </tr>  
