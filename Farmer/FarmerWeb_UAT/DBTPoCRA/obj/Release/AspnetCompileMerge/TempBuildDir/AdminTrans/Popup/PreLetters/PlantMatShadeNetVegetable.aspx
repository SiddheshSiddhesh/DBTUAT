<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantMatShadeNetVegetable.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.PlantMatShadeNetVegetable" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- शेडनेट हाऊस मध्ये भाजीपाला लागवड साहित्य </td>
                     </tr>  
                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:Literal ID="Literal15" runat="server"></asp:Literal></td>
                          ...
                          <tr>
                              <td>१०</td>
                              <td>शेडनेट हाऊस मध्ये भाजीपाला लागवड करिता पूर्वसंमती देण्यात आलेले क्षेत्र (हे. आर.) </td>
