<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DripIrrigationS.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.DripIrrigationS" %>
        ...
        <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- ठिबक सिंचन   </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक-A3.7.1) </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
                   ...
                   <tr>
                    ...
                    <tr>
                        <td>१०</td>
                        <td>ठिबक सिंचन बसविण्यासाठी मागणी केलेले क्षेत्र (हे. आर.) </td>
