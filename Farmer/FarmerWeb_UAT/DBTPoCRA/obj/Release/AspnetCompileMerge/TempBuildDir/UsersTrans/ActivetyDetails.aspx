        ...
        <ItemTemplate>
            <table class="table table-bordered table-hover data-tables">
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td><a href="ApplicationSubmit.aspx?T=<%# Eval("ActivityID") %>" class=" btn btn-danger"><asp:Label ID="Literal2" Text="Continue to Application" runat="server"></asp:Label> </a></td>
                </tr>
                <tr>
