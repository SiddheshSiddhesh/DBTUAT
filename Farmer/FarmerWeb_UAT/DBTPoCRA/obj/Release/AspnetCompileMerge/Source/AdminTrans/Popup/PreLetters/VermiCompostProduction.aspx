<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VermiCompostProduction.aspx.cs" Inherits="DBTPoCRA.AdminTrans.Popup.PreLetters.VermiCompostProduction" %>
          ...
          <center>
            <div style="border: medium double #CCCCCC; width: 8in; padding-right: 15px; padding-left: 15px;">
             <table class="auto-style1" style="table-layout: fixed; text-align: left; font-family: Calibri; font-size: 15px; ">
                    ...
                    <tr>
                         <td colspan="3" style="text-align:center">&nbsp; घटक- गांडुळ खत उत्पादन युनिट </td>
                     </tr>  
                    
                     <tr>
                         <td colspan="3" style="text-align:center">&nbsp; (प्रकल्प उपक्रम सांकेतांक- A2.6.1) </td>
                     </tr>                 
                    <tr>
                        <td></td>
                        <td>                       
